...
public:
	...
	virtual IClientTabletop* GetIClientTabletop( HSteamUser hSteamUser, HSteamPipe hSteamPipe, char const* pchVersion ) = 0;
	...
	virtual IClientControllerSerialized* GetIClientControllerSerialized( HSteamPipe hSteamPipe, char const* pchVersion ) = 0;

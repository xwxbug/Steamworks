...
const int k_cubAppProofOfPurchaseKeyMax_Old = 64;			// max bytes of a legacy cd key we support,3.42.61.66之后大小改变
...
struct AppProofOfPurchaseKeyResponse_Old_t
{
	enum { k_iCallback = k_iSteamAppsCallbacks + 13 };
	EResult m_eResult;
	uint32	m_nAppID;
	char	m_rgchKey[ k_cubAppProofOfPurchaseKeyMax_Old ];
};
